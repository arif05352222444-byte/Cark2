...
object AppColors {
    ...
    val Cyan = Color(0xFF19C3F0)
    val Fuchsia = Color(0xFFE63AC8)
    val Neon = Color(0xFF5AA8FF)
    val ButtonTop = Color(0xFF1D4FD0)
    val ButtonBottom = Color(0xFF0B2383)
...
/** Başlık / buton / puan fontu: Paytone One (SIL Open Font License, bkz. FONT_LICENSE_OFL.txt). */
val GameFont = FontFamily(Font(R.font.paytone_one))
